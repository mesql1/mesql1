...
um estudante de **Engenharia de Computação** na **Universidade Estadual do Maranhão (UEMA)** e desenvolvedor focado no ecossistema **Python/Django**. Tenho grande interesse em arquitetura de software, bancos de dados e automação.
